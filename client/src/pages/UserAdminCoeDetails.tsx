...
export default function UserAdminCoeDetails() {
  const { id } = useParams();
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground text-center mb-4">
                The requested COE document could not be found.
              </p>
              <Link href="/coe-info">
                <Button>
  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto p-6 space-y-6">
        ...
        {(coe.importantNotes || coe.visaApplicationInfo || coe.studyAustraliaLink) && (
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
            ...
            <CardContent className="space-y-4">
              ...
              <InfoItem label="Campus Location" value={coe.campusLocation} icon={MapPin} />
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <InfoItem label="File Size" value={coe.fileSize ? `${Math.round(coe.fileSize / 1024)} KB` : null} />
            <InfoItem label="Analysis Date" value={coe.createdAt ? format(new Date(coe.createdAt), 'MMMM dd, yyyy HH:mm') : null} icon={Calendar} />
          </CardContent>
        </Card>
      </div>
    </DashboardLayout>
