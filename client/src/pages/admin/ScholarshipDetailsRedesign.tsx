      ...
      <div className="min-w-0 flex-1">
        ...
        {isLink ? (
          <a 
            ...
            className="text-blue-600 hover:text-blue-800 underline break-words overflow-hidden text-wrap"
          >
            {displayValue}
          </a>
        ) : (
          <p className="text-gray-900 break-words overflow-hidden text-wrap">{displayValue}</p>
        )}
      </div>
    </div>
  );
