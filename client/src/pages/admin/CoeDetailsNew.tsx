...
export default function AdminCoeDetailsNew() {
  const { id } = useParams();
      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            <h1 className="text-3xl font-bold tracking-tight break-words overflow-hidden text-wrap">Admin COE Document Details</h1>
            <p className="text-muted-foreground break-words overflow-hidden text-wrap">
              Complete administrative view of {coe.fileName}
            </p>
          </div>
          <Link href="/admin/information-reports">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <InfoItem label="User ID" value={coe.userId.toString()} />
