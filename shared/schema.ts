...
export const userScholarshipPreferences = pgTable("user_scholarship_preferences", {
  ...
  preferredCountries: text("preferred_countries").array().default([]).notNull(),
  fieldsOfInterest: text("fields_of_interest").array().default([]).notNull(),
  academicLevel: text("academic_level"),
  budgetMin: integer("budget_min"),
  budgetMax: integer("budget_max"),
  needBasedPreference: boolean("need_based_preference").default(false).notNull(),
  meritBasedPreference: boolean("merit_based_preference").default(false).notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().notNull(),
});
