...
// The prompt for analyzing visa rejection letters
const PROMPT_TEMPLATE = `
You are an expert visa consultant specialized in analyzing visa rejection letters. 
Please analyze the following visa rejection letter and provide a comprehensive analysis.
...
/**
 * Analyzes a visa rejection letter using OpenAI's API
 * @param letterText The text content of the visa rejection letter
